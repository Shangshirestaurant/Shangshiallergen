...
// === Combined: ALWAYS show intro, smooth fade, scroll-fade header, modern theme ===
document.addEventListener('DOMContentLoaded', function(){
  ...
  function onScroll(){
    ...
    if (down) headerEls.forEach(el=>{ el.classList.remove('show-on-scroll'); el.classList.add('hide-on-scroll'); });
    else if (up) headerEls.forEach(el=>{ el.classList.remove('hide-on-scroll'); el.classList.add('show-on-scroll'); });
